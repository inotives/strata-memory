...
assert_contains "${VAULT}/AGENTS.md" '| `strata:semantic-refresh` | Rebuild local semantic embeddings when configured. |'
assert_contains "${VAULT}/AGENTS.md" '| `strata:semantic-status` | Report semantic search readiness and fallback mode. |'
